...
import 'conversas_exceptions.dart';

class ConversasApiClient {
  ConversasApiClient({
  ...
  Future<Map<String, dynamic>> listar() => _request('GET', '/chats');
  ...
  ConversasException _mapError(int statusCode) {
